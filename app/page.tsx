      ...
      <main className="flex-1">
        ...
        <section className="relative py-20 md:py-32 px-6 overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto flex flex-col items-center text-center space-y-10">
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-blue-100 dark:border-blue-900/30 bg-blue-50/50 dark:bg-blue-900/10 text-blue-700 dark:text-blue-300 text-xs font-bold tracking-wider uppercase animate-in fade-in slide-in-from-top-4 duration-700">
              <Zap className="h-3.5 w-3.5 fill-current" />
              <span>{t('hero.badge')}</span>
            </div>
            
            <h1 className="text-5xl md:text-8xl font-black tracking-tight text-slate-950 dark:text-white leading-[1.1] animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
              {t('hero.title_start')} <br />
              <span className="text-blue-600 underline decoration-blue-500/30 underline-offset-8">{t('hero.title_highlight')}</span>
            </h1>
            
            <p className="text-lg md:text-xl text-slate-600 dark:text-slate-400 max-w-2xl mx-auto leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-700 delay-200">
              {t('hero.description')}
            </p>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-10">
                {[
                    ...
                    <div key={idx} className="group relative p-8 rounded-3xl bg-white dark:bg-slate-950 border border-slate-100 dark:border-slate-900 hover:border-blue-500/30 transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/5">
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-6">
                        {[
                            ...
                            <div key={idx} className="flex items-start gap-4 p-4 rounded-2xl hover:bg-slate-50 dark:hover:bg-slate-900/50 transition-colors">
        ...
        <section id="pricing" className="py-24 px-6 relative overflow-hidden">
            <div className="max-w-4xl mx-auto text-center space-y-10 relative z-10">
                ...
                <div className="p-8 md:p-12 rounded-[2.5rem] bg-blue-600 text-white shadow-2xl shadow-blue-500/40 space-y-8">
                    ...
                    <ul className="grid sm:grid-cols-2 gap-4 text-left max-w-sm mx-auto font-medium">
                    ...
                    <Link href="/register" className="block">
                        <Button size="lg" className="h-16 px-12 text-xl bg-white text-blue-600 hover:bg-slate-100 rounded-2xl w-full sm:w-auto font-black transition-transform hover:scale-105">
                            {t('hero.cta_primary')}
                        </Button>
                    </Link>
                </div>
